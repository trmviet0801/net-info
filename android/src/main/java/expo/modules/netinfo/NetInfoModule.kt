...
class NetInfoModule : Module() {
  override fun definition() = ModuleDefinition {
    ...
    Function("isInternetReachable") { isInternetReachable() }

    Function("isWifiEnable") { isWifiEnable() }
  ...
  private fun isWifiEnable(): Boolean {
    val wm =
            appContext.reactContext?.getSystemService(Context.WIFI_SERVICE) as? WifiManager
                    ?: return false
